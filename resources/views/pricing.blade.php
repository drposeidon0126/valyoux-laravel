...
<style>
    ...
    <div class="row for-col-margin">
            ...
            <div class="card plan-box _1JscEqX4">
                <div class="card-body p-4">
                    ...
                    <div class="text-center plan-btn">
                        <a href="{{ url('crypto-buy-sell') }}" class="btn btn-black btn-sm waves-effect waves-light">Sign Artist</a>
                    </div>
        ...
        <!--            </div>-->
        <!--            <div class="text-center plan-btn">-->
        <!--                <a href="{{ url('crypto-buy-sell') }}" class="btn btn-success btn-sm waves-effect waves-light">Sign Artist</a>-->
        <!--            </div>-->
