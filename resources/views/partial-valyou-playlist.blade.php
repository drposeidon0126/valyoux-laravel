...
" placeholder=" Search for Investors
    ">
           <div class="mains3 col-sm-12 p-0" style="display:none;">
				...
				<img src="{{ asset('assets/images/Valyou-X-Investors-search-3788.svg') }}" style="
    position: absolute;
    width: 120px;
    top: 7px;
    left: 8px;
                    ...
                    <div class="col-6 col-md-4 col-lg-5">
                        <div class="media">
                            <div class="mr-3 align-self-center">
                                <img src="{{ isset($investor->avatar) ? asset($investor->avatar) : asset('/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-md rounded-circle ">
                            </div>
