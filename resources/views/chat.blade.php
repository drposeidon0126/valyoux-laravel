...
<div class="row ml-0 mr-0" id="messages_seen" style="display:block ; ">
    <div class=" d-lg-flex">
        <div class="back-btn-chat" style="display:none;">
            <img src="{{asset('assets/images/left-arrow.svg')}}" title="Go Back" style="height: 50px;width:50px;">
        </div>
                ...
                <div class="p-4 border-bottom msg-header"
                    ...
                    <div class="row">
                        <div class="align-self-center mr-3 chat_profile_pic">
                            <img src="{{asset(auth()->user()->avatar)}}" class="avatar-xs rounded-circle" alt="">
                        </div>
                        <div class="media-body">
                            <h5 class="font-size-15 mt-2 mb-1 getnameuser">{{auth()->user()->first_name }}
