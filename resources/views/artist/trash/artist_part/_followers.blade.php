 ...
 <?php  $count = artist_counter($artist->id); ?>
    ...
    <div class="row">
        ...
        <p class="artist-follower">Artists
            <span style="float:left; width:100%; display:block; text-align:center;">{{ $count->artist }}</span></p>
        </div>

        <div class="col-4">
            <p class="artist-follower">Investors<span style="float:left; width:100%; display:block; text-align:center;">{{ $count->investor }}</span></p>
        </div>

        <div class="col-4">
            <p class="artist-follower">Business<span style="float:left; width:100%; display:block; text-align:center;">{{ $count->business }}</span></p>
        </div>
        </div>
        </div>
