					...
					<div class="all-video-list card  p-2 desktop-mode">
						...
						<div class="special-video-part ">
							...
							<div class="especailly-part inline-flex w-full background-shadow px-2 my-2 pt-2 pb-2"
								onclick="selVideoDetail({{$row->id}}, 1)" style="width: 98.8%; margin:.7%">
								...
								<div class="video-detail-info py-1 pl-2">
									<p class="fs-2 font-weight-bold">{{@$row->singer}} - {{@$row->audio_title}}</p>
									<p style="font-size: small; font-weight: 200;">Song Valyou: <strong
											id="valyou-val">${{
											numberformat(@$row->artist->stock_value) }}</strong></p>
									<h6 class={{$row->artist->change_stock<0?'txt-main': 'text-green' }}><small>Stock
												Price
												&nbsp;<span><img class="" width="15" height="15"
														src="{{$row->artist->change_stock<0?'https://testvps.nwlogics.com/public/assets/images/valyoux/pink_arrow_circle_down.svg': 'https://testvps.nwlogics.com/public/assets/images/valyoux/green_arrow_price_going_up.svg'}}"></span>&nbsp;&nbsp;<strong>${{$row->artist->stock_value}}VXD</strong>&nbsp;<strong>{{$row->artist->change_stock
					...
					<div class="special-video-part ">
						...
						<div class="especailly-part inline-flex w-full background-shadow px-2 my-2 "
							...
							<div class="video-detail-info p-3">
								<p>{{@$row->singer}} - {{@$row->audio_title}}</p>
								<p style="font-size: small; font-weight: 200;">Song Valyou: <strong id="valyou-val">${{
										numberformat(@$row->artist->stock_value) }}</strong></p>
								<h6 class={{$row->artist->change_stock<0?'txt-main': 'text-green' }}><small>Stock Price
											&nbsp;<span><img class="" width="15" height="15"
													src="{{$row->artist->change_stock<0?'https://testvps.nwlogics.com/public/assets/images/valyoux/pink_arrow_circle_down.svg': 'https://testvps.nwlogics.com/public/assets/images/valyoux/green_arrow_price_going_up.svg'}}"></span>&nbsp;&nbsp;<strong>${{$row->artist->stock_value}}VXD</strong>&nbsp;<strong>{{$row->artist->change_stock
												<0?'': '+' }}{{$row->artist->change_stock}}%
											</strong></small></h6>
