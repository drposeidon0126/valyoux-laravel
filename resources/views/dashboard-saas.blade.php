                            ...
                            <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                    <div class="text-muted">
                                        <h2 class="mb-1 ml-4">{{ auth()->user()->first_name.' '.auth()->user()->last_name }}</h2>
                                        <p class="mb-2 ml-4">{{ auth()->user()->email }}</p>
                                        <img src="{{ asset('assets/images/valyoux/valyouxaccountverification_tick.svg') }}" alt="" height="20">
