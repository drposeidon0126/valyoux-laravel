...
<body>
    ...
    <div class="row logo-div justify-between align-center">
        ...
        <div class="mr-5 d-flex gap-2">
            <a class="btn btn-outline-success exchange bg-hoverevent py-1 logbtns" href="{{url('/login')}}">Login</a>
            <a class="btn btn-token-presale exchange text-hoverevent py-1 logbtns" href="{{url('/')}}">HOME</a>
            <div>
        ...
        <div class="px-5 w-full">
            ...
            <div class="row my-5 lg:ml-{120px}" >
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 d-flex align-center">
                    <div class="p-4">
                        <img src="{{asset('assets/images/valyoux/valyoux_black_logo.svg')}}" alt="" class="w-full">
                    </div>
                </div>
            </div>
                        ...
                        <div class="card bg-white border rounded">
                            <div class="card-body px-3">
                                ...
                                <a class="btn px-2 w-100"
                                    style="background-color: #ff4680; color: white; font-weight: 600; font-size: 16px; border-radius: 0.5rem;" href="{{url('/account-balance')}}">PRESELL</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 p-3">
