...
<?php if(isset($artist)){ ?>
    <input type="hidden" name="total_supply" id="total_supply" value="{{ numberformat($artist['total_supply']) }}">
            ...
            <div class="card mb-0 posFixed-sVxd" id="bs-float" style="margin-left: 0; margin-right: 0; height: 200px;" >
                <div class="card-body">
                    ...
                    <div class="d-flex d-flexBlock-mob justify-content-center bd-highlight align-items-center">
                        <div class="marquee">
                            <div class="track">
                                <div class="vxd d-inline pl-5">$ {{ numberformat($artist['stock_value']) * settings() -> admin_fees/100 + numberformat($artist['stock_value']) }} VXD</div>
                                 <?php $sign = '';
                                ...
                                $ {{ numberformat($artist['stock_value']) }} USDC</div>
                                <?php $sign = '';
                                if($artist['change_stock'] > 0){
                                    $change_stock = '+ '.numberformat($artist['change_stock']) ;
                                }else{
                            ...
                            <div class="text-center">
                                <div class="card-body price-card">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <input type="hidden" name="artist_id" value="{{ $artist['id'] }}" class="artist_id">

                                        <!-- <br/> -->

                                        <!-- stock value -->
                                        <input type="hidden" name="initial_stock_value" value="{{ numberformat($artist['stock_value']) }}" id="initial_stock_value"><!-- <br/><br/> -->

                                        <!-- Website fee -->
                                        <input type="hidden" id="admin_fees" value="{{ settings() -> admin_fees/100 }}"><!-- <br/><br/> -->

                                        <!-- Stock increments -->
                                        <input type="hidden" name="increments" value="{{ (float)settings()->increments }}" class="increments"><!-- <br/><br/> -->

                                        <!-- total Supply -->
                                        <input type="hidden" name="total_supply" id="total_supply" value="{{ $artist['total_supply'] }}"><!-- <br/><br/> -->

                                        <!-- circulating supply -->
                                        <input type="hidden" name="circulating_supply" id="circulating_supply" value="{{ $artist['circulating_supply'] }}"><!-- <br/><br/> -->

                                        <!-- remain_supply = limit_supply - circulating_supply -->
                                        <input type="hidden" name="remain_supply" id="remain_supply" value="{{ $stock_of_sell_limit - $artist['circulating_supply'] }}"><!-- <br/><br/> -->

                                        <!-- Admin Cost -->
                                        <input type="hidden" name="admin_cost" id="admin_cost" value="{{ numberformat($artist['stock_value']) * settings() -> admin_fees/100 + (float)settings()->increments }}"><!-- <br/><br/> -->

                                        <!-- Buyer Cost -->
                                        <input type="hidden" name="buyer_cost" id="buyer_cost" value="{{ numberformat($artist['stock_value']) * settings() -> admin_fees/100 + numberformat($artist['stock_value']) }}"><!-- <br/><br/> -->

                                        <!-- Artist Cost -->
                                        <input type="hidden" name="artist_cost" id="artist_cost" value="{{ (float)settings()->increments }}"><!-- <br/><br/> -->

                                    </div>
                                </div>
                                <br><br>

                                <h2 style="font-size: 24px; text-align: center; padding: 0 0 0; color: #1EDD0E;    font-weight: 700;">Total Cost: $ <span class="total_cost">{{ numberformat($artist['stock_value']) * settings() -> admin_fees/100 + numberformat($artist['stock_value']) }}</span> VXD</h2>
                                <br>
    ...
    <div class="modal fade proceed_modal" id="sellStockModal" aria-labelledby="buyStockModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4><b class="color-pinkk">Sell {{$artist['brand']}} Stocks</b></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="text-center">
                        <div class="card-body price-card price-card-pink">
                            ...
                            <div class="quantity">
                                ...
                                <input type="hidden" name="stock_value_sell" value="{{ numberformat($artist['stock_value']) }}" id="stock_value_sell">
                                <input type="hidden" name="artist_id" value="{{ $artist['id'] }}" class="artist_id">


                                <!-- stock value -->
                                <input type="hidden" name="initial_stock_value_sell" value="{{ numberformat($artist['stock_value']) }}" id="initial_stock_value_sell"><!-- <br/><br/> -->

                                <!-- Website fee -->
                                <input type="hidden" id="admin_fees_sell" value="{{ settings() -> admin_fees/100 }}"><!-- <br/><br/> -->

                                <!-- Market Maker Price -->
                                <input type="hidden" id="market_maker_price" name="market_maker_price" value="{{ $market_maker_price }}"><!-- <br/><br/> -->

                                <!-- Stock increments -->
                                <input type="hidden" name="increments" value="{{ (float)settings()->increments }}" class="increments_sell"><!-- <br/><br/> -->

                                <!-- total Supply -->
                                <input type="hidden" name="total_supply_sell" id="total_supply_sell" value="{{ $artist['total_supply'] }}"><!-- <br/><br/> -->

                                <!-- circulating supply -->
                                <input type="hidden" name="circulating_supply_sell" id="circulating_supply_sell" value="{{ $artist['circulating_supply'] }}"><!-- <br/><br/> -->

                                <!-- sell_restrictions -->
                                <input type="hidden" name="sell_restrictions" id="sell_restrictions" value="{{ $artist['sell_restrictions'] }}"><!-- <br/><br/> -->

                                <!-- Admin Cost -->
                                <input type="hidden" name="admin_cost_sell" id="admin_cost_sell" value="{{ numberformat($artist['stock_value'] *( 1- $market_maker_price) * settings() -> admin_fees/100) }}"><!-- <br/><br/> -->

                                <!-- Seller Cost -->
                                <input type="hidden" name="seller_cost" id="seller_cost" value="{{ numberformat((float)$artist['stock_value'] *( 1- $market_maker_price))-numberformat($artist['stock_value'] *( 1- $market_maker_price) * settings() -> admin_fees/100) }}"><!-- <br/><br/> -->

                                <!-- Artist Cost -->
                                <input type="hidden" name="artist_cost_sell" id="artist_cost_sell" value="{{ numberformat((float)$artist['stock_value'] *( 1- $market_maker_price)) }}"><!-- <br/><br/> -->

                            </div>
                        </div>
                        <br><br>
                        <h2 style="font-size: 24px; text-align: center; padding: 0 0 0; color: #ce196c;    font-weight: 700;">
                        Total Amount <br>You will receive: $ <span class="total_cost2">{{ numberformat($artist['stock_value'] *( 1- $market_maker_price) - $artist['stock_value'] *( 1- $market_maker_price) * settings() -> admin_fees/100) }}</span> VXD
                        </h2>
                        <br>
