...
@section('content')
    @component('common-components.breadcrumb')
        @slot('title')UPLOAD AUDIO/VIDEO SONG @endslot
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <!-- <form id="upload_media" method="POST" onsubmit="event.preventDefault();uploadMedia(this)" action="{{ route('artist.upload') }}" class="custom-validation" enctype="multipart/form-data"> -->
            <form id="upload_media" method="POST" action="{{ route('admin.upload') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
