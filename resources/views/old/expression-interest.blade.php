                ...
                <div class="card-body">
                    ...
                    <form action="#" class="custom-validation">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required placeholder="{{ ucwords(str_replace('_',' ','first_name')) }}"/>
                        </div>
                        <div class="form-group">
                            <label>{{ ucwords(str_replace('_',' ','last_name')) }}</label>
                            <input type="text" class="form-control" required placeholder="{{ ucwords(str_replace('_',' ','last_name')) }}"/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" required placeholder="{{ ucwords(str_replace('_',' ','email')) }}"/>
                        </div>

                        <div class="form-group">
                            <label>Contact Number Country code, e.g. AU is +61 or U.S is +1</label>
                            <input type="number" class="form-control" required placeholder="{{ ucwords(str_replace('_',' ','contact')) }}"/>
                        </div>
