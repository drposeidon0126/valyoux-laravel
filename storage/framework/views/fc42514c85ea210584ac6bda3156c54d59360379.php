                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="pt-4">
                                ...
                                <div class="mt-4 row">
                                    <div class="col-6">
                                    <a href="<?php echo e(url('admin-profile')); ?>" class="btn-green waves-effect waves-light btn-sm" style="width: auto;">View Profile <i class="mdi mdi-arrow-right ml-1"></i></a>
                                    </div>
                                    <div class="col-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/admin-profile.blade.php ENDPATH**/ ?>