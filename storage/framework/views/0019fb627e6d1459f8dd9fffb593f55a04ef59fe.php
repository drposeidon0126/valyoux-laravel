            ...
            <nav class="navbar navbar-expand-lg navbar-light nav-right-margin">
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav top-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px; color:#050f3f " href="<?php echo e(url('account-balance')); ?>">Bank</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px" href="<?php echo e(url('market')); ?>">Market</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px" href="<?php echo e(route('admin.social-media')); ?>">Social Media</a>
                        </li>
                        
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.watch')); ?>" class="nav-link" style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px">Watch & Earn</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.listenandearn')); ?>" class="nav-link" style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px">Listen & Earn</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(url('store')); ?>" class="nav-link" style="font-family: color: inherit; font-weight:400; 'Roboto', sans-serif; font-size: 16px; color:#050f3f">Store</a>
                        </li>
...
<?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend\valyoux_backend\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>