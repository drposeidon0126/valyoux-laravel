...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('first_name', !empty($user->first_name) ? $user->first_name : '')); ?>" required placeholder="<?php echo e(ucwords(str_replace('_',' ','first_name'))); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required placeholder="<?php echo e(ucwords(str_replace('_',' ','last_name'))); ?>" value="<?php echo e(old('last_name', !empty($user->last_name) ? $user->last_name : '')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" required value="<?php echo e(old('dob', !empty($user->dob) ? $user->dob : '')); ?>"/>
                            <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" required placeholder="<?php echo e(ucwords(str_replace('_',' ','email'))); ?>" value="<?php echo e(old('email', !empty($user->email) ? $user->email : '')); ?>"/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" required placeholder="<?php echo e(ucwords(str_replace('_',' ','contact'))); ?>" value="<?php echo e(!empty($user->contact) ? $user->contact : ''); ?>"/>
                        </div>

                        <h4 class="card-title">Address1</h4>
                        <div class="form-group">
                            <label>City / Suburb</label>
                            <input type="text" class="form-control" required placeholder="City / Suburb" value="<?php echo e($user->city ?? ''); ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Unit/Level</label>
                            <input type="text" class="form-control" required placeholder="Unit/Level" value="<?php echo e($user->unit ?? ''); ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Street Number (PO Box not acceptable)</label>
                            <input type="text" class="form-control" required placeholder="Street Number (PO Box not acceptable)" value="<?php echo e($user->street_number ?? ''); ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Street Name</label>
                            <input type="text" class="form-control" required placeholder="Street Name" value="<?php echo e($user->street_name ?? ''); ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Country</label>
...
<?php $__env->startSection('script-bottom'); ?>
    <script>
        (function () {
            $('.dropify').dropify();
            const selectedCountry = `<?php echo e($user->country ?? ''); ?>`;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/admin/user/profile.blade.php ENDPATH**/ ?>