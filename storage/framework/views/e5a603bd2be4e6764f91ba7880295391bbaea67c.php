...
<!-- Left Sidebar End -->
<form id="logoutform" action="<?php echo e(route('logout')); ?>" style="display: none" method="POST"><?php echo csrf_field(); ?></form><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend(12.21)\valyoux_backend\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>