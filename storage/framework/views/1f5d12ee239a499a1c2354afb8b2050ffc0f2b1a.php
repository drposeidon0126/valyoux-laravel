...
<body>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="nav flex-sm-column flex-column">
                            ...
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer" href="<?php echo e(url('/')); ?>">Home</a>
                            <a class="nav-item font-weight-700 txt-xl menu-col cursur-pointer" href="<?php echo e(url('/market')); ?>">Market</a>
        ...
        <div class="px-5 w-full">
            ...
            <div class="row my-5" ">
                ...
                <div class="row" style="display:flex; flex-direction: row; flex-wrap: nowrap;">
                    <a href="https://forms.gle/JgzGnxYopcPo4f6Q8" target="_blank" class="btn btn-pink w-auto btn-sm w-md waves-effect waves-light mr-2 ml-3 d-flex p-3">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Documents\Valyou X\valyoux_backend\valyoux_backend\resources\views/home.blade.php ENDPATH**/ ?>