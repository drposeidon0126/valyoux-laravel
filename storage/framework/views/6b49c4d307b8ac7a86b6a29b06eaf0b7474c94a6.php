...
<?php $__env->startSection('content'); ?>
	...
	<!--    <div class="col-lg-12">-->
			...
			<!--                                    <source src="<?php echo e(asset('assets/videos/video.mp4')); ?>" type="video/mp4">-->
			<!--                                </video>-->
			<!--                            </div>-->
			<!--                        </div>-->
			<!--                    </div> <!-- end col -->
	...
	<div class="social-post">
		...
		<!--					        <img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/uploads/user/69619967.png')); ?>" alt="">-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/videos.blade.php ENDPATH**/ ?>