        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route(request()->segment(1).'.'.request()->segment(2).'.store')); ?>" class="custom-validation" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php if(isset($business['id']) && $business['id']): ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  value="<?= (isset($business['occupation']))?$business['occupation']:'' ?>" name="occupation" />
                        </div>
                        <div class="form-group">
                            <label>About your business - What is the purpose of your business or services you provide words 250 words</label>
                            <textarea  class="form-control" name="about" rows="5" data-parsley-maxlength="250"><?= (isset($business['about']))?$business['about']:'' ?></textarea>
                        </div>
                        <p class="card-title-desc">How do we find your business</p>
                        <div class="form-group">
                            <label>Website link</label>
                            <input type="url" class="form-control" name="website" value="<?= (isset($business['website']))?$business['website']:'' ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Instagram</label>
                            <input type="url" class="form-control" name="instagram" value="<?= (isset($business['instagram']))?$business['instagram']:'' ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Facebook</label>
                            <input type="url" class="form-control" name="facebook"  value="<?= (isset($business['facebook']))?$business['facebook']:'' ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Twitter</label>
                            <input type="text" class="form-control" name="twitter"  value="<?= (isset($business['twitter']))?$business['twitter']:'' ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Youtube</label>
                            <input type="url" class="form-control" name="youtube"  value="<?= (isset($business['youtube']))?$business['youtube']:'' ?>"/>
                        </div>
                        <div class="form-group">
                            <label>Other Link</label>
                            <input type="text" class="form-control" name="otherlink"  value="<?= (isset($business['otherlink']))?$business['otherlink']:'' ?>"/>
                        </div>
                        ...
                        <div class="card">
                            <div class="body">
                                <input type="file" id="avatar" class="dropify" name="photo">
                            </div>
                        </div>
...
<?php if(isset($business['id']) && $business['id']): ?>
<script>
      let imagenUrl = `<?php echo e(asset($business->photo ?? 'assets/images/users/avator.png')); ?>`;
            $('.dropify').dropify(
                {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/business/create.blade.php ENDPATH**/ ?>