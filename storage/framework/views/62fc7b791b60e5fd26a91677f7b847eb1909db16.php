...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('common-components.breadcrumb'); ?>
        ...
        <?php $__env->slot('li_2'); ?> Crypto <?php $__env->endSlot(); ?>
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            ...
            <div class="row">
                ...
                <?php $__env->startComponent('common-components.crypto-widget'); ?>
                    <?php $__env->slot('iconClass'); ?> mdi mdi-bitcoin h2 text-warning align-middle mb-0 mr-3 <?php $__env->endSlot(); ?>
                    <?php $__env->slot('title'); ?> Bitcoin <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> $ 9134.39 <?php $__env->endSlot(); ?>
                    <?php $__env->slot('rate'); ?> + 0.0012 ( 0.2 % ) <?php $__env->endSlot(); ?>
                    <?php $__env->slot('chartId'); ?> area-sparkline-chart-1 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>

                <?php $__env->startComponent('common-components.crypto-widget'); ?>
                    <?php $__env->slot('iconClass'); ?> mdi mdi-ethereum h2 text-primary align-middle mb-0 mr-3 <?php $__env->endSlot(); ?>
                    <?php $__env->slot('title'); ?> Ethereum <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> $ 245.44 <?php $__env->endSlot(); ?>
                    <?php $__env->slot('rate'); ?> - 4.102 ( 0.1 % ) <?php $__env->endSlot(); ?>
                    <?php $__env->slot('chartId'); ?> area-sparkline-chart-2 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>

                <?php $__env->startComponent('common-components.crypto-widget'); ?>
                    <?php $__env->slot('iconClass'); ?> mdi mdi-litecoin h2 text-info align-middle mb-0 mr-3 <?php $__env->endSlot(); ?>
                    <?php $__env->slot('title'); ?> litecoin <?php $__env->endSlot(); ?>
                    <?php $__env->slot('price'); ?> $ 63.61 <?php $__env->endSlot(); ?>
                    <?php $__env->slot('rate'); ?> + 1.792 ( 0.1 % ) <?php $__env->endSlot(); ?>
                    <?php $__env->slot('chartId'); ?> area-sparkline-chart-3 <?php $__env->endSlot(); ?>
                <?php echo $__env->renderComponent(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/dashboard-crypto.blade.php ENDPATH**/ ?>