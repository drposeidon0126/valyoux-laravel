                ...
                <div class="card-body">
                    <div class="float-right">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user_create')): ?>
                            <a class="btn btn-v-green" href="<?php echo e(route('admin.'.request()->segment(1).'.create')); ?>"><?php echo e(trans('global.add')); ?> <?php echo e(trans('cruds.user.title_singular')); ?></a>
                        <?php endif; ?>
                    </div>
                    <table id="example1" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        <tr>
                            ...
                            <th><?php echo e(ucwords(str_replace('_',' ','first_name'))); ?></th>
                            <th><?php echo e(ucwords(str_replace('_',' ','last_name'))); ?></th>
                            <th><?php echo e(ucwords(str_replace('_',' ','email'))); ?></th>
                            <th><?php echo e(ucwords(str_replace('_',' ','dob'))); ?></th>
                            <th><?php echo e(ucwords(str_replace('_',' ','role'))); ?></th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        <tbody></tbody>
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tr>
                                <th><?php echo e(ucwords(str_replace('_',' ','roles'))); ?></th>
...
<?php $__env->startSection('script-bottom'); ?>
    <script>
        $(function(){
            var source = `<?php echo e(route('admin.'.request()->segment(1).'.index')); ?>`;
            ...
            $(document, this).on('click', '.view', function () {
                let id = $(this).attr('id');
                $.ajax({
                    url: `<?php echo e(url(request()->segment(1).'/')); ?>/${id}`,
                    dataType: "json",
                    success: function (data) {
                        let roles = '';
                        data.roles.forEach(data => roles += `<span class="badge badge-info">${data.title}</span>&nbsp;`)
                        let image = (data.avatar != undefined) ? `<?php echo e(asset('/')); ?>${data.avatar}` : `<?php echo e(asset('assets/images/users/avator.png')); ?>`;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/admin/user/list.blade.php ENDPATH**/ ?>