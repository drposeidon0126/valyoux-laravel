...
<div id="uploading-section-artist-mobile" style="display: none">
	<div class="tab-select">
		<div class="carosel-box col-4">
			<div class="row">
				<div class="col-5 carosel-box-img-div">
					<img src="<?php echo e(asset('assets/images/valyoux/drake-valyou_x_music@2x.png')); ?>" width="59" height="59" class="rounded-circle avatar-xm m-1"
						alt="">
				</div>
				<div class="col-7 carosel-box-img-div  ">
					...
					<div class="col-12">
						<p class="uploading-section-artist-mobile-p3"><img class="uploading-section-artist-mobile--icon-img" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>"> +$312.3</p>
					</div>
				</div>
			</div>
		</div>
		<div class="carosel-box col-4">
			<div class="row">
				<div class="col-5 carosel-box-img-div">
					<img src="<?php echo e(asset('assets/images/valyoux/justin_beiber_valyou_x_music@2x.png')); ?>" width="59" height="59" class="rounded-circle avatar-xm m-1"
						alt="">
				</div>
				<div class="col-7 carosel-box-img-div  ">
					<div class="col-12">
		...
		<div class="carosel-box col-4">
			<div class="row">
				<div class="col-5 carosel-box-img-div">
					<img src="<?php echo e(asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png')); ?>" width="59" height="59" class="rounded-circle avatar-xm m-1"
						alt="">
				</div>
				<div class="col-7 carosel-box-img-div ">
					<div class="col-12">
			...
			<div class="uploading-section card-body">
				<div class="row">
					<div class="col-lg-2 col-4 marginnone ">
						<img src="<?php echo e(URL::asset('assets/images/valyoux/Kanye_west_valyou_x_music@2x.png')); ?>" alt="" class="avatar-md rounded-circle post-img ">
					</div>
						...
						<div class="col-lg-12 col-12">
							<div class="row">
								<div class="col-lg-2 col-3">
									<img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/images/valyoux/drake-valyou_x_music@2x.png')); ?>" alt="">
								</div>
				...
				<div class="post-section card-body">
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="row">
								<div class="col-lg-2 col-3">
									<img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/images/valyoux/bobby_k9_valyou_x_music250@2x.png')); ?>" alt="">
								</div>
								<div class="col-lg-7 col-6 post-header-bar">
					...
					<div class="card">
						...
						<div class="p-3 chat-input-section">
							<div class="row text-center">
								<div class="col-md-2 col-2">
									<div class="mr-3">
										<img src="<?php echo e(URL::asset('assets/images/valyoux/bobby_k9_valyou_x_music250@2x.png')); ?>" alt="" class="avatar-md rounded-circle ">
									</div>
								</div>
								...
								<div class="col-md-2 col-2">
									<img style="transform: rotate(270deg);" class="mr-3 comment-btn" style="height:30px; width:30px" src="<?php echo e(asset('assets/images/valyoux/pink_arrow_circle_down.svg')); ?>"> 
								</div>
							</div>
						</div>
					</div>
				...
				<div class="post-section card-body">
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="row">
								<div class="col-lg-2 col-3">
									<img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/images/valyoux/moniq.png')); ?>" alt="">
								</div>
								<div class="col-lg-7 col-6 post-header-bar">
				...
				<div class="post-section card-body">
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="row">
								<div class="col-lg-2 col-3">
									<img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png')); ?>" alt="">
								</div>
								<div class="col-lg-7 col-6 post-header-bar">
								...
								<li>
									<div class="row">
										<div class="col-md-4 col-12">
											<div class="row artist-comment-image-div">
												<div class="col-md-4 col-2 ">
													<img src="<?php echo e(URL::asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png')); ?>" alt="" class="avatar-md rounded-circle ">
												</div>
												<div class="col-md-8 col-10 mt-4">
													<p class="text-dark font-size-12 artist-comment-name">Bobby k9</p>
												</div>
		...
		<div class="social-post">
				...
				<div class="post-section card-body">
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="row">
								<div class="col-lg-2 col-3">
									<img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/images/valyoux/pro_artist@2x.png')); ?>" alt="">
								</div>
								<div class="col-lg-7 col-6 post-header-bar">
			...
			<div class="row">
			    <div class="col-sm-12">
        		    ...
        		    <div class="social-media-profile-wrap">
        		        <div class="sm-left-wrap">
        		            <img src="<?php echo e(URL::asset('assets/images/valyoux/pro_artist@2x.png')); ?>" alt="" class="avatar-md rounded-circle img-40">
        		            <div class="sm-left-desc">
        						<h5>Artist share price</h5>
								...
								<li>
									<div class="row">
										<div class="col-md-4 col-12">
											<div class="row artist-comment-image-div">
												<div class="col-md-4 col-2 ">
													<img src="<?php echo e(URL::asset('assets/images/valyoux/pro_artist@2x.png')); ?>" alt="" class="avatar-md rounded-circle ">
												</div>
												<div class="col-md-8 col-10 mt-4">
													<p class="text-dark font-size-12 artist-comment-name">Bobby k9</p>
												</div>
				...
				<div class="post-section card-body">
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="row">
								<div class="col-lg-2 col-3">
									<img class="post-section-artist-img rounded-circle" src="<?php echo e(URL::asset('assets/images/valyoux/dre-450new.png')); ?>" alt="">
								</div>
		...
		<div class="uploading-section-artist">
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-4 col-4">
							<img src="<?php echo e(asset('assets/images/valyoux/nicky_minaj_valyou_x@2x.png')); ?>" width="50" height="50" class="rounded-circle avatar-xm m-1"
								alt="">
						</div>
						<div class="col-lg-6 col-6 ml-1">
							...
							<p class="uploading-section-artist-p3"><img class="uploading-section-artist-icon-img" src="<?php echo e(asset('assets/images/valyoux/green_arrow_price_going_up.svg')); ?>"> +$312.3</p>
						</div>
					</div>
				</div>
			</div>
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-4 col-4 ">
							<img src="<?php echo e(asset('assets/images/valyoux/beyonce.svg')); ?>" width="50" height="50" class="rounded-circle avatar-xm m-1"
								alt="">
						</div>
						<div class="col-lg-6 col-6 ml-1">
			...
			<div class="card">
				<div class=" card-body">
					<div class="row">
						<div class="col-lg-4 col-4 ">
							<img src="<?php echo e(asset('assets/images/valyoux/justin_beiber_valyou_x_music@2x.png')); ?>" width="50" height="50" class="rounded-circle avatar-xm m-1"
								alt="">
						</div>
						<div class="col-lg-6 col-6 ml-1">
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						<div class="col-lg-4 col-4 ">
							<img src="<?php echo e(asset('assets/images/valyoux/drake-valyou_x_music@2x.png')); ?>" width="50" height="50" class="rounded-circle avatar-xm m-1"
								alt="">
						</div>
						<div class="col-lg-6 col-6 ml-1">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/old/social-media--oldd.blade.php ENDPATH**/ ?>