                ...
                <div class="card-body bg-black">
                    <div class="row">
                        <div class="col-3 col-md-1 col-lg-1 col-sm-1">
                            <img src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg')); ?>" alt="" class="rounded-circle" width="100%">
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/testvps-main/resources/views/old/songs-olderr.blade.php ENDPATH**/ ?>