...
<div class="content">
    <div class="row">
        <div class="col-lg-12">
            ...
            <form id="send_email_form" method="POST" action="{{ route('admin.send_email') }}" class="custom-validation" enctype="multipart/form-data">
              @csrf
              <div class="row m-2">
                <div class="col-5">
                    <h3>SMTPS</h3>
                    <div class="form-inline smtp-list justify-content-center">
                        <div id="smtp-info" class="row mb-2 smtp-info">
                ...
                <div class="col-7">
                    ...
                    <div class="row">
                        <div class="form-group col-4">
                            ...
                            <input type="email" class="form-control" id="sender_name" name="sender_name" placeholder="Sender Name">
                        </div>
                        <div class="form-group col-4">
                            {{-- <label for="pwd">Sender Email(use smtp email as default):</label> --}}
                            <input type="email" class="form-control" id="sender_email" name="sender_email" placeholder="Sender Email(use smtp email as default):">
                        </div>
                        <div class="form-group col-4">
                            {{-- <label for="pwd">Reply / bounceback email :</label> --}}
                            <input type="email" class="form-control" id="reply_email" name="reply_email" placeholder="Reply / bounceback email">
                        </div>
                    </div>
                    <div class="row" style="min-height: 450px;">
                        <div class="form-group col-8 d-flex flex-column ">
                            ...
                            {{-- <label for="usr">MESSAGE (HTML)</label> --}}
                            <textarea class="form-control mb-3" id="message_body" name="message_body" rows="20" style="flex:1" placeholder="MESSAGE(HTML)"></textarea>
                            <label>Shortcode to Use in Letter/Message</label>
                            ...
                            <label for="usr"> ATTACH FILE</label>
                            <div class="row">
                                <div class="col-sm-6">
                        ...
                        <div class="form-group col-4 d-flex flex-column">
                            {{-- <label for="subject">URL in Message/Letter Shortcode [LINK]</label> --}}
                            <input type="text" class="form-control mb-3" id="subject" name="subject" placeholder="URL in Message/Letter Shortcode [LINK]">
                            {{-- <label for="usr">Emails List</label> --}}
                            <textarea class="form-control" id="receiver_email_list" name="receiver_email_list" rows="20" style="flex:1" placeholder="Emails List to Send"></textarea>
                        </div>
                    </div>
                    <div class="row m-1">

                            <button type="button" onclick="send_email()" class="btn btn-primary pull-right send-email-btn w-50">Start Send</button>
                            <button type="button" onclick="stop_email()" class="btn btn-danger pull-right stop-email-btn w-50" disabled>Pause Send</button>
